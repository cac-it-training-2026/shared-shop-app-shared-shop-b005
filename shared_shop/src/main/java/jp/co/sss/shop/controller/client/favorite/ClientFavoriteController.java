...
public class ClientFavoriteController {
	...
	public String toggleFavorite(@PathVariable Integer itemId, HttpServletRequest request) {
		...
		if (referer != null && contextPath != null && referer.contains(contextPath + "/")) {
			String path = referer.substring(referer.indexOf(contextPath) + contextPath.length());
